...
CREATE TABLE SpotifyClone.history_played(
	user_id INT NOT NULL,
...
INSERT INTO
	SpotifyClone.subscription_plan(plan, price)
VALUES
	('gratuito', 0.00),
	('universitario', 5.99),
	('pessoal', 6.99),
...
INSERT INTO
	SpotifyClone.users(user_name, age, plan_id, subscription_date)
VALUES
...
INSERT INTO 
	SpotifyClone.albums(album_name, artist_id, release_year)
VALUES
	('Renaissance', 1, 2022),
	('Jazz', 2,  1978),
	('Hot Space', 2, 1982),
...
INSERT INTO 
	SpotifyClone.songs(song_name, artist_id, album_id, length_seconds)
VALUES
...
INSERT INTO 
   SpotifyClone.history_played(user_id, song_id, date_played) 
VALUES
